...
import TruongHuuLong.LeaderBoards;
...
public class LeaderboardsPanel extends GuiPanel{
	...
	private String title = "Leader Boards";
	...
	public LeaderboardsPanel(){
		...
		GuiButton backButton = new GuiButton(Game.WIDTH / 2 - backButtonWidth / 2, 500, backButtonWidth, 50);
	...
	public void render(Graphics2D g){
		super.render(g);
		g.setColor(Color.black);
		g.drawString(title, Game.WIDTH / 2 - DrawUtils.getMessageWitdth(title, titleFont, g) / 2, DrawUtils.getMessageHeight(title, titleFont, g) + 40);
		drawLeaderboards(g);
	}
